...
import com.ahmedzenhom.mysampleapp.di.activity.ActivityComponent;
import com.ahmedzenhom.mysampleapp.di.activity.DaggerActivityComponent;
...
public abstract class BaseActivity<T extends ViewBinding> extends AppCompatActivity implements BaseView {
    ...
    private void initDagger() {
        daggerComponent = DaggerActivityComponent.builder()
                .applicationComponent(MySampleApp.get(this).getComponent())
